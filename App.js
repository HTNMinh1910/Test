...
const Home = (props) => {
   ...
   fontWeight: "600",
   margin: 5}}>Giới chủ</Text>
      <View style={{justifyContent: 'space-around', flexDirection: 'row', padding: 10, width: "100%"}}>
        <Button title='Manager' onPress={() => nav.navigate("Manager", {nameManager: "San Pham"})}></Button>
        <Button title='About' onPress={() => nav.navigate("About", {name: "Ha Tran Ngoc Minh", id: "PH27570"})}></Button>
      </View>
    </View>)
}
const App=()=> {
